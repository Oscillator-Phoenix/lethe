...
- Periodic Deletes on Timestamp
  ...
  _"In our interactions with engineers working on LSM-based production systems, we learned **that periodic deletes of a large fraction of data based on timestamp are very frequent**."_
...
_As a course report on Advanced Database Systems Fall 2020, this document is written by kitchen in SYSU on 20201222._
